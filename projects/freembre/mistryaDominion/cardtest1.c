 ...
 *
 * Note: this test was updated as it previously had an error.
 */
...
int main() {
	...
	choice1 = 1;
       ...
       printf("Before function: DeckCount: %d, discard Count %d, handCount: %d\n", testG.deckCount[thisPlayer], testG.discardCount[thisPlayer], testG.handCount[thisPlayer]);
    
	cardEffect(smithy, choice1, choice2, choice3, &testG, handpos, &bonus);

    printf("After function: DeckCount: %d, discard Count %d, handCount: %d\n", testG.deckCount[thisPlayer], testG.discardCount[thisPlayer], testG.handCount[thisPlayer]);
